 ...
 */
final class Version20210504092044 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP validate');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD validate TINYINT(1) NOT NULL');
    }
}
